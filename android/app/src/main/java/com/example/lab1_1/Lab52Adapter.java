...
public class Lab52Adapter extends ArrayAdapter<Fruit> {
    ...
    public Lab52Adapter(Context context, int textViewResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.item_listview5_2, parent, false);
